...
public class RecoveryPaySlips {
    ...
    public RecoveryPaySlips() {
    }

    //Constructor with Arguments to initialise data and access the data if needed

    public RecoveryPaySlips(int payslip_id, String employee_id, double gross_salary, double deductions, double net_salary, LocalDate date_generated) {
