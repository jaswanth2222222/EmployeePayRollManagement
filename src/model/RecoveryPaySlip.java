...
public class RecoveryPaySlip {
    ...
    public RecoveryPaySlip() {
    }

    //Constructor with Arguments to initialise data and access the data if needed

    public RecoveryPaySlip(int payslipId, String employeeId, double grossSalary, double deductions, double netSalary, LocalDate dateGenerated) {
