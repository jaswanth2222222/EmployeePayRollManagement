...
public class EmployeeDaoImpl implements EmployeeDao {
	...
	final CallingService validationService = new CallingService();
	...
	public boolean addEmployee(Employee employee) {
		...
		try (Connection connection = dataBaseConnection.getDataBaseConnection();
			...
			System.out
					.println("An Error Occurred while inserting Employee " + "Details into Database." + e.getMessage());
			throw new RuntimeException(e);
		}
	}
...
// This method is designed to retrieve the Employee Details Based on their
	...
	public Employee findEmployeeById(String employeeId) {
		...
		try (Connection connection = dataBaseConnection.getDataBaseConnection();
			...
			if (resultSet.next()) {
				Employee foundEmployee = new Employee(resultSet.getString("employee_id"), resultSet.getString("name"),
			...
			System.out
					.println("An Error Occurred while Fetching Employee " + "Detains into Database." + e.getMessage());
			throw new RuntimeException(e);
		}
		return null;
	}
	...
	public int getCountOfEmployeesInDept(String departmentName) {
		...
		try (Connection connection = dataBaseConnection.getDataBaseConnection();
			...
			System.out.println("An Error Occured while Counting Employee in a Department " + e.getMessage());
			throw new RuntimeException(e);
		}
	}
	...
	public double getAverageSalaryOfDepartment(String departmentName) {
		...
		try (Connection connection = dataBaseConnection.getDataBaseConnection();
			...
			System.out.println("An Error Occured while Calculating the Average Salary " + e.getMessage());
			throw new RuntimeException(e);
		}
	...
	public ArrayList<Employee> getAllEmployeesByDeptName(String departmentName) {
		...
		try (Connection connection = dataBaseConnection.getDataBaseConnection();
			...
			System.out.println("An Error Occured while Fetching Employees in a Department " + e.getMessage());
			throw new RuntimeException(e);
		}
	}
	...
	public boolean deleteEmployee(String employeeId) {
		...
		try {
			...
			System.out.println("An Error Occured while Removing the Employee " + e.getMessage());
			throw new RuntimeException(e);
		}
